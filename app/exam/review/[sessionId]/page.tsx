        ...
        <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/30 rounded-xl p-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-white font-semibold mb-1">AI-Powered Explanations</p>
              <p className="text-white/70 text-sm">
                Click "Get AI Explanation" on any question to receive a detailed explanation powered by Azure OpenAI
              </p>
            </div>
          </div>
        </div>
